...
export class RegisterComponent implements OnInit {
 ...
 constructor(
  ...
  async register() {
     ...
     if (this.name && this.email && this.phone && this.password &&this.isChecked ) {
